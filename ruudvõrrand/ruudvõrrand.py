...
lbl=Label(aken,text="Ruutvõrrandi lahendus",font="Calibri 26",fg="green",bg="lightblue")
lbl.pack()
...
btn=Button(aken,text="Arvutada",font="Calibri 26",bg="green",command=lahenda)
btn.pack(side=LEFT)


vastus=Label(aken,height=4,width=20,bg="yellow")
